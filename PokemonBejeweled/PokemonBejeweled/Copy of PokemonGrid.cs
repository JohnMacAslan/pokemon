...
//            Console.Out.WriteLine("_pokemon----------------------------------");
//            printGrid(_pokemon);
//            Console.Out.WriteLine("_newPokemon----------------------------------");
//            printGrid(_newPokemon);
...
//        private void printGrid(IBasicPokemonToken[,] grid)
//        {
...
//            int counter;
//            int lastRow = gridSize - 1;
//            for (int col = 0; col < gridSize; col++)
//            {
//                numberOfTokensToPullDown = 0;
//                for (int row = gridSize - 1; row > 0; row--)
//                {
//                    while (row > 0 && null == _pokemon[row, col])
//                    {
//                        row--;
//                        numberOfTokensToPullDown++;
//                    }
//                    _pokemon[row + numberOfTokensToPullDown, col] = _pokemon[row, col];
//                    _pokemon[row, col] = null;
//                }
//                counter = 0;
//                while (counter < numberOfTokensToPullDown)
//                {
//                    _pokemon[counter++, col] = generateNewPokemon();
//                }
//            }
//        }
